...
ELSE WRITE(OUTPUT,'?')END;END;END;10:END;}
{:181}{182:}BEGIN WRITELN(OUTPUT,'This is TANGLE-GPC');INITIALIZE;
...
UNTIL NEXTCONTROL=136;WHILE NOT INPUTHASENDE DO SCANMODULE;
